...
public class ViewDragHelper {
    ...
    private void dragTo(int i, int i2, int i3, int i4) {
        ...
        if (i3 != 0) {
            ...
            this.mCapturedView.offsetLeftAndRight(iClampViewPositionHorizontal - left);
        } else {
        ...
        if (i4 != 0) {
            ...
            this.mCapturedView.offsetTopAndBottom(iClampViewPositionVertical - top);
        } else {
    ...
    public boolean continueSettling(boolean z) {
        ...
        if (this.mDragState == 2) {
            ...
            if (zComputeScrollOffset && currX == this.mScroller.getFinalX() && currY == this.mScroller.getFinalY()) {
                this.mScroller.abortAnimation();
                zIsFinished = this.mScroller.isFinished();
            } else {
                zIsFinished = zComputeScrollOffset;
            }
            if (!zIsFinished) {
                if (z) {
    ...
    public boolean shouldInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        switch (actionMasked) {
            ...
            case 5:
                ...
                } else if (this.mDragState == 2 && (viewFindTopChildUnder2 = findTopChildUnder((int) x3, (int) y3)) == this.mCapturedView) {
