...
public class PagerTitleStrip extends ViewGroup implements ViewPager.Decor {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec((int) (size * 0.8f), ExploreByTouchHelper.INVALID_ID);
        int iMakeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(size2 - paddingTop, ExploreByTouchHelper.INVALID_ID);
    ...
    void updateText(int i, PagerAdapter pagerAdapter) {
        ...
        int iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec((int) (width * 0.8f), ExploreByTouchHelper.INVALID_ID);
        int iMakeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(height, ExploreByTouchHelper.INVALID_ID);
        this.mPrevText.measure(iMakeMeasureSpec, iMakeMeasureSpec2);
        this.mCurrText.measure(iMakeMeasureSpec, iMakeMeasureSpec2);
        this.mNextText.measure(iMakeMeasureSpec, iMakeMeasureSpec2);
