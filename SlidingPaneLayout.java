...
public class SlidingPaneLayout extends ViewGroup {
    ...
    private void parallaxOtherViews(float f) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (childAt != this.mSlideableView) {
                ...
                childAt.offsetLeftAndRight(i2 - ((int) ((1.0f - f) * this.mParallaxBy)));
                if (z) {
        ...
        while (i7 < childCount) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.slideable) {
                    int iMin = (Math.min(width, (i6 - paddingRight) - this.mOverhangSize) - paddingLeft) - (layoutParams.leftMargin + layoutParams.rightMargin);
                    this.mSlideRange = iMin;
                    layoutParams.dimWhenOffset = ((layoutParams.leftMargin + paddingLeft) + iMin) + (measuredWidth / 2) > i6 - paddingRight;
                    i5 = layoutParams.leftMargin + ((int) (iMin * this.mSlideOffset)) + paddingLeft;
                } else {
                    i8 = (!this.mCanSlide || this.mParallaxBy == 0) ? 0 : (int) ((1.0f - this.mSlideOffset) * this.mParallaxBy);
                    i5 = width;
                }
                int i9 = i5 - i8;
    ...
    /* JADX WARN: Removed duplicated region for block: B:37:0x00c0 A[PHI: r2
  0x00c0: PHI (r2v12 float) = (r2v11 float), (r2v14 float) binds: [B:34:0x00b7, B:36:0x00be] A[DONT_GENERATE, DONT_INLINE]] */
    @Override // android.view.View
    /*
    ...
    */
    ...
    boolean smoothSlideTo(float f, int i) {
        ...
        LayoutParams layoutParams = (LayoutParams) this.mSlideableView.getLayoutParams();
        if (!this.mDragHelper.smoothSlideViewTo(this.mSlideableView, (int) (layoutParams.leftMargin + getPaddingLeft() + (this.mSlideRange * f)), this.mSlideableView.getTop())) {
            return false;
        }
